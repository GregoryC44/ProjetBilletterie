...
CREATE USER 'cgregory_util'@'localhost' IDENTIFIED BY 'secret'; GRANT USAGE ON *.* TO 'cgregory_util'@'localhost' REQUIRE NONE WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;
GRANT ALL PRIVILEGES ON `cgregory_festival`.* TO 'cgregory_util'@'localhost' WITH GRANT OPTION;

--
-- Base de données :  `ydurand_festival`
--
CREATE DATABASE IF NOT EXISTS `cgregory_festival` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `cgregory_festival`;
...
(21, '14/07/2019', 4, 'g024', '16:30', '19:00'),
(22, '14/07/2020', 4, 'g024', '16:30', '19:00');
